...
<%@include file="/WEB-INF/views/common/common_msg.jsp" %>
	<s:form id="searchForm" action="permission" method="post" namespace="/" theme="simple">
		<div id="container">
						...
						<tbody>
							<s:iterator value="#pageResult.pageResult">
								...
								<td><input type="checkbox" name="IDCheck" class="acb" autocomplete="off" data-eid="<s:property value="id"/>"/></td>
									...
									<!-- 
										<s:a namespace="/" action="permission_input"><s:param name="permission.id" value="id"/>编辑</s:a>
										<s:a namespace="/" action="permission_delete"><s:param name="permission.id" value="id"/>删除</s:a>
									 -->
									</td>
								</tr>
							</s:iterator>
