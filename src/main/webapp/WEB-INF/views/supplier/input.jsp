...
<!--====================================-->
<s:form name="editForm" action="supplier_saveOrUpdate" method="post" id="editForm" theme="simple">
    <s:hidden name="supplier.id"/>
    <div id="container">
        <div id="nav_links">
            <span style="color: #1A5CC6;">供货商编辑</span>
            <div id="page_close">
                <a>
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    <td class="ui_text_rt" width="140">供货商地址</td>
                    <td class="ui_text_lt">
                        <s:textfield name="supplier.address" cssClass="ui_input_txt02"/>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">供货商电话</td>
                    <td class="ui_text_lt">
