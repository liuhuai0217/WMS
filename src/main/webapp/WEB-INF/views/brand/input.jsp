...
<!--====================================-->
<s:form name="editForm" action="brand_saveOrUpdate" method="post" id="editForm" theme="simple">
    ...
    <div id="container">
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                <tr>
                    <td class="ui_text_rt" width="140">商品类别</td>
                    <td class="ui_text_lt">
                        <s:textfield name="brand.name" cssClass="ui_input_txt02"/>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">类别编号</td>
                    <td class="ui_text_lt">
