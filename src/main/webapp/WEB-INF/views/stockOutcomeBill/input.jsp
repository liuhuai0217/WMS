...
<head>
    ...
    <script type="text/javascript">
        $(function () {	
        	...
        	}).on("change","[tag=number],[tag=salePrice]",function(){
                var tr = $(this).closest("tr");
...
<!--====================================-->
<s:form name="editForm" action="stockOutcomeBill_saveOrUpdate" method="post" id="editForm" theme="simple">
    ...
    <div id="container">
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    <td class="ui_text_rt" width="140">仓库选择</td>
                   <td>
           			<s:select list="#depots" listKey="id" listValue="name" headerKey="-1"
           			headerValue="全部仓库" name="stockOutcomeBill.depot.id" cssClass="ui_select01"
           			></s:select>
                   </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">客户选择</td>
                   <td>
           			<s:select list="#clients" listKey="id" listValue="name" headerKey="-1"
           			headerValue="全部客户" name="stockOutcomeBill.client.id" cssClass="ui_select01"
           			></s:select>
                   </td>
                </tr>
                <tr>
