...
<!--====================================-->
<s:form name="editForm" action="systemMenu_saveOrUpdate" method="post" id="editForm" theme="simple">
            ...
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                 ...
                 <tr>
                    ...
                    <s:hidden name="qo.parentId"/>
                        <s:textfield value="%{parentName}" cssClass="ui_input_txt02" readonly="true" style="background:grey"/>
                    </td>
                </tr>
                <tr>
