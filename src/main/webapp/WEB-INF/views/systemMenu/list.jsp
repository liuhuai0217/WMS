            ...
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <s:url var="url" namespace="/" action="systemMenu_input">
                        ...
                        <input type="button" value="新增" class="ui_input_btn01 btn_input" data-url="<s:property value="#url"/>"/>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <s:iterator value="#pageResult.pageResult">
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- 添加子菜单 -->
                                <s:url namespace="/" action="systemMenu" var="url">
                                	<s:param name="qo.parentId"  value="id"/>
                                </s:url>
								<a href="<s:property value="#url"/>">查看子菜单</a>
